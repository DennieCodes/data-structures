...
def test_remove_from_middle_list_removes_value_and_reduces_length():
    from linked_list import LinkedList
    list = LinkedList()
    list.insert(100)
    list.insert(99)
    ...
    assert list.get(1) == 98


def test_remove_method_for_last_index_removes_value_at_tail_reduces_length_returns_value():
    from linked_list import LinkedList
    list = LinkedList()
    list.insert(100)
    list.insert(99)
...
def test_get_with_negative_index_gets_value_from_end_of_list():
    from linked_list import LinkedList
    list = LinkedList()
    list.insert(100)
    list.insert(99)
    ...
    list.insert(97)
    list.insert(96)
    assert list.get(-1) == 96
    assert list.get(-2) == 97
    assert list.get(-3) == 98
    assert list.get(-4) == 99
    assert list.get(-5) == 100
